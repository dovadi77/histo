...
/******/ 			if (chunkId === "node_modules_simple-datatables_src_date_js") return "" + chunkId + ".js";
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "DataTable:";
...
const initTable = (componentID) => {
    return new simple_datatables__WEBPACK_IMPORTED_MODULE_0__.DataTable(`#${componentID}`);
};
